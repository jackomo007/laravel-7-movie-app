...
@section('content')
    <div class="movie-info border-b boder-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{$detailsMovie['poster_path']}}" alt="{{ $detailsMovie['title']}}" class="w-64 md:w-96">
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        @foreach ($detailsMovie['crew'] as $crew)
                            <div class="mr-8">
                                <div>{{ $crew['name']}}</div>
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                            <iframe
                                                ...
                                                src="https://youtube.com/embed/{{ $detailsMovie['videos']['results'][0]['key'] }}"
                                                style="border: 0;"
    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($detailsMovie['cast'] as $cast)
                    <div class="mt-8">
                        <a href="{{route('actors.show', $cast['id'])}}">
                            <img src="{{'https://image.tmdb.org/t/p/w300/'.$cast['profile_path']}}" class="rounded-full hover:opacity-75 transition ease-in-out duration-150">
                        </a>
    ...
    <div class="movie-images" x-data="{isOpen: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($detailsMovie['images'] as $cast)
                    <div class="mt-8">
                        <a
                            @click.prevent="
                                isOpen = true
